            ...
            <div className="flex flex-col items-center justify-center text-center h-full max-w-lg mx-auto">
                <Card className="w-full">
                    <CardHeader>
                        ...
                        <CardTitle className="font-headline text-2xl pt-4">Application Complete!</CardTitle>
             ...
             <div className="flex flex-col items-center justify-center text-center h-full max-w-lg mx-auto">
                <Card className="w-full">
                    <CardHeader>
                        ...
                        <CardTitle className="font-headline text-2xl pt-4">Medicare Supplement Application</CardTitle>
                        <CardDescription>Let's get you enrolled in the right plan.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <p className="text-sm text-muted-foreground">This application will help us determine your eligibility for a Medicare Supplement insurance policy. The process should take about 5-10 minutes.</p>
                        <Alert>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Please follow the steps to complete your enrollment.</p>
      </div>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            {step === 2 && ( // Medicare Details
                <Card>
                    <CardHeader><CardTitle>Medicare Details</CardTitle></CardHeader>
                    <CardContent className="space-y-4">
            ...
            {step === 3 && ( // Current Coverage
                 <Card>
                    <CardHeader><CardTitle>Current Coverage</CardTitle><CardDescription>Tell us about any other health insurance you have.</CardDescription></CardHeader>
            ...
            {step === 4 && ( // Medical History
                 <Card>
                    <CardHeader><CardTitle>Medical Questions</CardTitle><CardDescription>Your answers help determine eligibility and are kept confidential.</CardDescription></CardHeader>
                    <CardContent className="space-y-6">
            ...
            {step === 5 && ( // Plan Selection
                <Card>
                    <CardHeader><CardTitle>Plan Selection</CardTitle></CardHeader>
                    <CardContent className="space-y-6">
            ...
            {step === 6 && ( // Agent Assistance
                <Card>
                    <CardHeader><CardTitle>Agent Assistance</CardTitle></CardHeader>
                    <CardContent className="space-y-4">
            ...
            {step === 7 && ( // Review & Submit
                 <Card>
                    <CardHeader><CardTitle>Review Your Application</CardTitle><CardDescription>Please review all information for accuracy before submitting.</CardDescription></CardHeader>
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-4 rounded-lg border bg-background/50 p-4">
                            <h4 className="font-headline font-semibold">Disclosures & Consent</h4>
                            <div className="space-y-2 text-xs text-muted-foreground max-h-32 overflow-y-auto">
