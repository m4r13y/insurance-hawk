...
const steps = [
    { id: 1, name: 'Personal Information', fields: ['firstName', 'lastName', 'dob', 'address', 'city', 'state', 'zip', 'phone', 'email'] as FieldPath<FormSchemaType>[] },
    { id: 2, name: 'Medicare Information', fields: ['medicareClaimNumber'] as FieldPath<FormSchemaType>[] },
    { id: 3, name: 'Plan Selection & Signature', fields: ['planId', 'signature'] as FieldPath<FormSchemaType>[] },
]
