  ...
  return (
    <div className={cn('flex flex-wrap gap-3', className)}>
      {items.map(item => {
        ...
        return (
          <div key={item.carrierId+item.category} className="group flex items-center gap-3 rounded-full border px-3 py-1.5 bg-white dark:bg-slate-800 shadow-sm hover:shadow transition dark:border-slate-600 relative pr-8">
            ...
            <button
              type="button"
              onClick={() => removeByCarrier(item.carrierId, item.category)}
