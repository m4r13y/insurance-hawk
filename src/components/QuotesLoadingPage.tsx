...
interface QuotesLoadingPageProps {
  quoteType: 'medigap' | 'advantage' | 'partd' | 'dental';
  zipCode?: string;
  age?: string;
}
...
const loadingSteps = {
  medigap: [
    ...
    { id: 3, text: "Calculating real-time premiums", icon: TokensIcon, duration: 2500 },
  ...
  partd: [
    { id: 1, text: "Finding Part D plans in your area", icon: MagnifyingGlassIcon, duration: 2000 },
    { id: 2, text: "Checking drug formularies", icon: LockClosedIcon, duration: 3000 },
    { id: 3, text: "Calculating prescription costs", icon: TokensIcon, duration: 2500 },
    { id: 4, text: "Comparing pharmacy networks", icon: FileTextIcon, duration: 2000 },
    { id: 5, text: "Generating your quotes", icon: CheckCircledIcon, duration: 1500 }
  ],
  dental: [
    { id: 1, text: "Searching dental plans in your area", icon: MagnifyingGlassIcon, duration: 2000 },
    { id: 2, text: "Verifying provider networks", icon: LockClosedIcon, duration: 2500 },
    { id: 3, text: "Analyzing coverage and costs", icon: TokensIcon, duration: 3000 },
    { id: 4, text: "Checking benefit details", icon: FileTextIcon, duration: 2000 },
    { id: 5, text: "Finalizing your options", icon: CheckCircledIcon, duration: 1500 }
  ]
};
...
const quoteTypeLabels = {
  ...
  partd: "Part D Prescription Drug",
...
const tips = {
  ...
  partd: [
    "Enrollment in Part D is voluntary but you may pay a penalty for late enrollment",
    "Check if your medications are covered in the plan's formulary",
    "Consider both monthly premiums and prescription copays when comparing"
  ],
  dental: [
    "Dental insurance often has waiting periods for major procedures",
    "Check annual maximums and coverage percentages for different services",
    "Some plans offer immediate coverage for preventive care like cleanings"
  ]
};

export default function QuotesLoadingPage({ quoteType, zipCode, age }: QuotesLoadingPageProps) {
