...
export default function FinalExpenseEmptyState({ 
  ...
  description = "We couldn't find any final expense life insurance plans for your area. Please try adjusting your search criteria or contact us for assistance."
