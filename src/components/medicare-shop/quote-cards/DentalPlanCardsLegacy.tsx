...
import type { DentalCarrierSummary } from './DentalPlanCards';

interface Props { carriers: DentalCarrierSummary[]; loading: boolean; onOpenCarrierDetails?: (c: DentalCarrierSummary) => void; }

// Legacy variant keeps original layout (price prominent). The new variant can evolve later to emphasize benefits/riders if needed.
const DentalPlanCardsLegacy: React.FC<Props> = ({ carriers, loading, onOpenCarrierDetails }) => {
...
export default DentalPlanCardsLegacy;
