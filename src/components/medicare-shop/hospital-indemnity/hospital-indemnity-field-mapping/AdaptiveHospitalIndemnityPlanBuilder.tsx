        ...
        <CardContent>
          <Tabs value={currentStep.toString()} onValueChange={(value) => setCurrentStep(parseInt(value))}>
            ...
            <TabsContent value="2" className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold mb-4">Configure Benefits</h3>
            ...
            <TabsContent value="3" className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold mb-4">Optional Riders</h3>
                ...
                <div className="space-y-6">
                  {(() => {
                    ...
                    console.log('🎯 Available riders:', availableRiders.length, availableRiders);
                    const categorizedRiders = categorizeRiders(availableRiders);
                    console.log('🎯 Categorized riders:', categorizedRiders);
                    
                    if (availableRiders.length === 0) {
                      return (
                        <div className="text-center py-8 text-gray-500">
                          <p>No rider options available.</p>
                          <p className="text-sm mt-2">This may be because no quotes have been loaded or the selected plan doesn't have optional riders.</p>
                        </div>
                      );
                    }
                      ...
                      <div key={category} className="space-y-4">
                        ...
                        <div className="space-y-4">
                          {riders.map((rider: any) => {
                            ...
                            return (
                              <Card key={rider.name} className={`border-2 transition-colors ${
                                ...
                                <CardContent className="p-4">
                                  <div className="space-y-4">
                                      ...
                                      <div className="text-right">
                                        {isSelected && selectedConfig?.selectedBenefitOption && (
                                          <div className="font-medium text-green-600">
                                            +{formatCurrency(selectedConfig.selectedBenefitOption.rate)}/month
                                          </div>
                                        )}
                                      </div>
                                    </div>
                                    ...
                                    {rider.benefitOptions && rider.benefitOptions.length > 0 && (
                                      <div>
                                        <h6 className="text-sm font-medium mb-2">Select Benefit Amount:</h6>
                                        <RadioGroup
                    ...
                    <CardContent className="p-6">
                      <div className="space-y-4">
                        ...
                        {selectedRiders.length > 0 && (
                          <div>
                            <h4 className="font-medium mb-2">Selected Riders:</h4>
                            <div className="space-y-2">
                              {selectedRiders.map(riderConfig => (
                                <div key={riderConfig.name} className="flex justify-between text-sm">
                                  <span>{riderConfig.name}</span>
                                  {riderConfig.selectedBenefitOption && (
                                    <span className="text-green-600">
                                      +{formatCurrency(riderConfig.selectedBenefitOption.rate)}/month
                                    </span>
                                  )}
                                </div>
                              ))}
