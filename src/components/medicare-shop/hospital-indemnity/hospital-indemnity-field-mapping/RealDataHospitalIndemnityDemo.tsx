...
// Demo component using real Firestore data
export function RealDataHospitalIndemnityDemo() {
  ...
  const handlePlanBuilt = (selectedQuote: OptimizedHospitalIndemnityQuote, configuration: any) => {
    ...
    // In a real app, this would save the configuration or navigate to checkout
  };
...
export default RealDataHospitalIndemnityDemo;