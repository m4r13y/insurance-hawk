  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Drug Plan Options</h2>
          <p className="text-gray-600">Compare Medicare Part D and Medicare Advantage + Part D plans</p>
        </div>
        <div className="text-sm text-gray-500">
          Showing {paginatedQuotes.length} of {filteredQuotes.length} plans
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Select value={sortBy} onValueChange={setSortBy}>
          ...
          <SelectContent>
            ...
            <SelectItem value="deductible">Annual Deductible</SelectItem>
        ...
        <Select value={filterBy} onValueChange={setFilterBy}>
          ...
          <SelectContent>
            ...
            <SelectItem value="pdp">Part D Only</SelectItem>
            <SelectItem value="mapd">Medicare Advantage + Part D</SelectItem>
            <SelectItem value="special-needs">Special Needs Plans</SelectItem>
          </SelectContent>
        </Select>
