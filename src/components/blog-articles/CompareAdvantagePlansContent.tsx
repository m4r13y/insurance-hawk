...
export function CompareAdvantagePlansContent() {
  return (
    <div className="grid lg:grid-cols-3 gap-y-8 lg:gap-y-0 lg:gap-x-12">
      <BlogContent>
        <BlogHeader
          title="Compare Advantage Plans"
          category="Medicare"
          date="July 22, 2025"
          intro="How people determine if Medicare Advantage is the right choice."
          breadcrumbLabel="Resources"
        />
        <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
                This is a placeholder for the Compare Advantage Plans article. The content will be filled in later.
            </p>
        </div>
        <ActionButtons
