    ...
    <div className="grid lg:grid-cols-3 gap-y-8 lg:gap-y-0 lg:gap-x-12">
      <BlogContent>
        <BlogHeader
          ...
          category="Medicare"
          date="July 22, 2025"
          intro="Know when to sign up and make changes to your Medicare."
          breadcrumbLabel="Resources"
        />
        <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
                This is a placeholder for the Enrollment Periods article. The content will be filled in later.
            </p>
        </div>
        <ActionButtons
