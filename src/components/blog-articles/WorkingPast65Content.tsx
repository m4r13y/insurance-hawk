    ...
    <div className="grid lg:grid-cols-3 gap-y-8 lg:gap-y-0 lg:gap-x-12">
      <BlogContent>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-6">
            ...
            <p>Missing Medicare deadlines is a costly mistake. To avoid this, use the <strong>Special Enrollment Period (SEP)</strong>. This gives you up to eight months to sign up for Part B (and up to two months for Part D) after you stop working or lose your group health coverage. Don’t wait until the last minute—getting your paperwork in order early can help you avoid coverage gaps or delays.</p>
