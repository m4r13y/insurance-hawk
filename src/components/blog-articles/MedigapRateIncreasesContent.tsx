  ...
  return (
    <div className="grid lg:grid-cols-3 gap-y-8 lg:gap-y-0 lg:gap-x-12">
      ...
      <BlogSidebar
        ...
        mediaLinks={[
          { title: "Top Plan G Add-ons", imageUrl: "https://placehold.co/320x320.png", href: "/dashboard/resources/top-plan-g-addons" },
          { title: "Top Plan N Add-ons", imageUrl: "https://placehold.co/320x320.png", href: "/dashboard/resources/top-plan-n-addons" }
        ]}
      />
    </div>
  );
