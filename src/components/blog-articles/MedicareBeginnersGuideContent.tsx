...
export function MedicareBeginnersGuideContent() {
  return (
    <div className="grid lg:grid-cols-3 gap-y-8 lg:gap-y-0 lg:gap-x-12">
      <BlogContent>
        <BlogHeader
          title="Medicare Beginner's Guide"
          category="Medicare"
          date="July 22, 2025"
          intro="Learn everything you need to know when starting Medicare."
          breadcrumbLabel="Resources"
        />
        <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
                This is a placeholder for the Medicare Beginner's Guide article. The content will be filled in later.
            </p>
        </div>
        <ActionButtons
            badges={[{ tag: "Medicare" }, { tag: "Guide" }]}
            likes={0}
            comments={0}
          />
      </BlogContent>
