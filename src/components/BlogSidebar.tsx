    ...
    <div className="sticky top-0 start-0 py-16 lg:ps-8">
      ...
      <div className="group flex items-center gap-x-3 border-b border-border pb-8 mb-8 dark:border-neutral-700">
        ...
        <a className="group grow block focus:outline-hidden" href="">
          <h5 className="group-hover:text-muted-foreground group-focus:text-muted-foreground text-base font-semibold text-foreground dark:group-hover:text-neutral-400 dark:group-focus:text-neutral-400 dark:text-neutral-200">
            {author.name}
          </h5>
          <p className="text-base text-muted-foreground dark:text-neutral-500">
            {author.bio}
          </p>
        </a>
        <div className="grow">
          <div className="flex justify-end">
            <button type="button" className="py-1.5 px-2.5 inline-flex items-center gap-x-2 text-xs font-medium rounded-lg border border-transparent bg-primary text-primary-foreground hover:bg-primary/90 focus:outline-hidden focus:bg-primary/80 disabled:opacity-50 disabled:pointer-events-none">
      ...
      <div className="space-y-6">
        {mediaLinks.map((media, idx) => (
          <a key={idx} className="group flex items-center gap-x-6 focus:outline-hidden" href={media.href}>
            <div className="grow">
              <span className="text-sm font-bold text-foreground group-hover:text-primary group-focus:text-primary dark:text-neutral-200 dark:group-hover:text-primary dark:group-focus:text-primary">
                {media.title}
              </span>
            </div>
