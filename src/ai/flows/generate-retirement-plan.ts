...
const prompt = ai.definePrompt({
  ...
  Use markdown and prepend each main '##' heading with a relevant emoji to make it visually engaging (e.g., 🛡️ for Insurance, 📈 for Investments).
