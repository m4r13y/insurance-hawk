...
const prompt = ai.definePrompt({
  ...
  Use markdown. For each main '##' heading, prepend it with a relevant icon name from the lucide-react library, formatted as '[ICON:IconName]'.
  Here are the sections and suggested icons:
  - For the Summary: [ICON:PartyPopper]
  - For Insurance: [ICON:Shield]
  - For Investments/Income: [ICON:TrendingUp]
  - For Tax Planning: [ICON:Landmark]
  - For Estate Planning: [ICON:FileText]
  - For Next Steps: [ICON:Rocket]
  - For the Disclaimer: [ICON:AlertTriangle]
  Example: '## [ICON:Shield] Insurance Review'

  Structure the plan as follows:

  ## [ICON:PartyPopper] Retirement Plan Summary
  ...
  ## [ICON:TrendingUp] Investment & Income Strategy
  ...
  ## [ICON:AlertTriangle] Important Disclaimer
