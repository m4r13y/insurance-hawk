...
const TabsDemo = () => (
	...
	>
		...
		<Tabs.Content
			className="grow rounded-b-md bg-card p-5 outline-none focus:shadow-[0_0_0_2px] focus:shadow-black"
			value="tab1"
		>
